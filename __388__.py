...
##      RELIANT OF CREATE LIST | index:(388 | i Type) Review File               ##
...
print("temp test not working yet")
exit()                      
##############################################################################################################################
...
##                a.write(Records)
    ...
    print(f"9999 : 388 {Suppress Items}")
