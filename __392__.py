...
##################################################################################
##                                                                              ##
##	SYS-Daily Accounts Created.py rev.2                                     ##
...
##      RELIANT OF CREATE LIST | index:(392 | p Type) Review File               ##
...
if __name__ == "__392__": # 392
    ...
    echo('################################')
    echo('##                            ##')
    echo('## SYS-Daily Accounts Created ##')
    echo('##                            ##')
    echo('################################')
...
##    Records = JSON.Write()    
    ...
    print(f"9999 : 392 {{SUB.NAME}}")

print(__name__, '{Daily Accounts Created} COMPLETE!')
