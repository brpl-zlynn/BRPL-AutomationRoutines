...
##################################################################################
##                                                                              ##
##	SYS-Daily Accounts Renewed.py rev.2                                     ##
##	Script for running Daily Accounts Renewed create lists.                 ##
##                                                                              ##
##	Created By Zachary Lynn.                                                ##
##      Updated on 10.07.2022 by Zachary Lynn for BRPL-ILS.                     ##
...
if __name__ == "__394__": # 394
    ...
    echo('################################')
    echo('##                            ##')
    echo('## SYS-Daily Accounts Renewed ##')
    echo('##                            ##')
    echo('################################')
...
#####################################################
    ...
    TOOL.wait(2)                                    #
                                                    #
    a.write('SYS-' + SUB.NAME)                     #   # Renewed #
    SIERRA.Create_lists.JSON(SUB.NAME)             # 
                                                    #
...
##    Records = JSON.Write()    
    ...
    try: # Always try | except. For error catching.
        if Records != '': # Program specific conditional : Patron(s) Renewed
            a.write(Records)
            a.press('tab')
            a.write('Renewed')
            a.press('tab')
    ...
    print(f"9999 : 394 {{SUB.NAME}}")

print(__name__, '{Daily Accounts Renewed} COMPLETE!')
